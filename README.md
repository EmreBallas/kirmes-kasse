...
- **Helfer:** Die Zahlart «Helfer» fragt einen Namen ab (bekannte Namen stehen als Knöpfe bereit) und bietet «Gleich zahlen» oder «Später zahlen». Später zahlen speichert den Beleg als offene Schuld des Helfers, druckt die Coupons und nimmt kein Geld. Ein eigener Bildschirm «Helfer» zeigt den offenen Saldo je Name über alle Tage und nimmt Zahlungen entgegen (Bar oder Twint, auch Teilbeträge). Der Abschluss weist Helferessen, erhaltene Helfer-Zahlungen und die offenen Schulden je Name aus.
